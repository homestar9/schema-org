...
component extends="schema-org.types.Text" accessors="true" {
    ...
    property name="phoneticText" hint="Representation of a text [[textValue]] using the specified [[speechToTextMarkup]]. For example the city name of Houston in IPA: /ˈhjuːstən/.";
