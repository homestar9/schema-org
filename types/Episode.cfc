...
component extends="schema-org.types.CreativeWork" accessors="true" {
    ...
    property name="episodeNumber" hint="Position of the episode within an ordered group of episodes.";

    property name="musicBy" hint="The composer of the soundtrack.";

    property name="partOfSeason" hint="The season to which this episode belongs.";
