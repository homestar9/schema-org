// --------------------------------------------------------
// AUTO-GENERATED: PaymentChargeSpecification.cfc
...
component extends="schema-org.types.PriceSpecification" accessors="true" {
    ...
    property name="appliesToPaymentMethod" hint="The payment method(s) to which the payment charge specification applies.";


    variables[ "@type" ] = "PaymentChargeSpecification";
