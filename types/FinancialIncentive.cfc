// --------------------------------------------------------
// AUTO-GENERATED: FinancialIncentive.cfc
...
component extends="schema-org.types.Intangible" accessors="true" {
    ...
    property name="eligibleWithSupplier" hint="The supplier of the incentivized item/service for which the incentive is valid for such as a utility company, merchant, or contractor.";

    property name="incentiveAmount" hint="Describes the amount that can be redeemed from this incentive.
...
<li>Use [[LoanOrCredit]] for loans/credits.</li>
    ...
    property name="incentiveStatus" hint="The status of the incentive (active, on hold, retired, etc.).";

    property name="incentiveType" hint="The type of incentive offered (tax credit/rebate, tax deduction, tax waiver, subsidies, etc.).";

    property name="incentivizedItem" hint="The type or specific product(s) and/or service(s) being incentivized.
...
For multiple different incentivized items, use multiple [[DefinedTerm]] or [[Product]].";
    ...
    property name="incomeLimit" hint="Optional. Income limit for which the incentive is applicable for.
...
Use Text for incentives that are limited based on other criteria, for example if an incentive is only available to recipients making 120% of the median poverty income in their area.";
    ...
    property name="purchasePriceLimit" hint="Optional. The maximum price the item can have and still qualify for this offer.";

    property name="purchaseType" hint="Optional. The type of purchase the consumer must make in order to qualify for this incentive.";

    property name="qualifiedExpense" hint="Optional. The types of expenses that are covered by the incentive. For example some incentives are only for the goods (tangible items) but the services (labor) are excluded.";
