// --------------------------------------------------------
// AUTO-GENERATED: PublicationIssue.cfc
// Do not hand-edit; re-run generator to update.
// --------------------------------------------------------

component extends="schema-org.types.CreativeWork" accessors="true" {

    property name="issueNumber" hint="Identifies the issue of publication; for example, 'iii' or '2'.";
    ...
    variables[ "@type" ] = "PublicationIssue";
